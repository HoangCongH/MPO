...
namespace MPO_Web_Prj.Controllers.Report.PPReport
{
    ...
    public class PPReport_ByPartController : Controller
    {
        ...
        [HttpGet("Index")]
        [HttpPost("Index")]
        public async Task<IActionResult> Index([FromForm] PickPlacementByPartFilter filter, CancellationToken cancellationToken)
        {
        ...
        public async Task<IActionResult> ExportExcel([FromForm] PickPlacementByPartFilter filter, CancellationToken cancellationToken)
        {
        ...
        [HttpPost("Batch")]
        public async Task<IActionResult> Batch([FromForm] PickPlacementByPartFilter filter, [FromForm] int offset, CancellationToken cancellationToken)
        {
            filter.IsApplied = ReportFilterGuard.HasRequiredDateTime(filter);
        ...
        public async Task<IActionResult> Options(
            ...
            [FromQuery] int limit,
            [FromForm] PickPlacementByPartFilter filter,
            CancellationToken cancellationToken)
        {
            filter.IsApplied = ReportFilterGuard.HasRequiredDateTime(filter);
            return Json(await reportService.GetFilterOptionsAsync(filter, search, limit, cancellationToken));
        }
