    ...
    public class PPReport_ByNozzleController : Controller
    {
        ...
        public async Task<IActionResult> ExportExcel([FromForm] PickPlacementByNozzleFilter filter, CancellationToken cancellationToken)
        {
            ...
            html.AppendLine(isProMode
                ? "<tr><th>Line Name</th><th>Machine Name</th><th>Stage</th><th>Nozzle Name</th><th>Nozzle Slot</th><th>Nozzle Changer slot</th><th>Pickup count</th><th>Placement count</th><th>Total miss</th><th>Scrap ratio</th></tr>"
                : "<tr><th>Line Name</th><th>Machine Name</th><th>Stage</th><th>Nozzle Name</th><th>Nozzle Slot</th><th>Nozzle Changer slot</th><th>Pickup count</th><th>Placement count</th><th>Pickup miss</th><th>Recog miss</th><th>Height miss</th><th>Drop miss</th><th>Mount miss</th><th>Transfer miss</th><th>Scrap ratio</th></tr>");
