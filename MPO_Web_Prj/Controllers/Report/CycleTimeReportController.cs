...
public class CycleTimeReportController : Controller
{
    ...
    [HttpPost("Batch")]
    public async Task<IActionResult> Batch([FromForm] CycleTimeReportFilter filter, [FromForm] int offset, CancellationToken cancellationToken)
    {
        filter.IsApplied = ReportFilterGuard.HasRequiredDateTime(filter);
    ...
    public async Task<IActionResult> Options(
        ...
        [FromQuery] int limit,
        [FromForm] CycleTimeReportFilter filter,
